...
class DT_Post_Title extends Widget_Base {
	...
	public function get_title() {
		...
		return __( 'DT Page/Post Title', 'detheme-kit' );
	...
	protected function render() {
		...
		$html = sprintf( '<%1$s class="dt-post-title %2$s">', $settings['html_tag'], $animation_class );
		if ( $link ) {
	...
	protected function _content_template() {
		...
		<#
			...
			var html = '<' + settings.html_tag + ' class="dt-post-title ' + animation_class + '">';
			if ( link_url ) {
