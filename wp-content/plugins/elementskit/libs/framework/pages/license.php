            ...
            <div class="ekit_tab_wraper">
                ...
                <div class="ekit-admin-card attr-tab-content ekit-admin-card-shadow">
                    ...
                    <div class="attr-card-body">
                        ...
                        <ol>
                            <li><?php printf( esc_html__( 'Log in to your %sWpmet account%s to get your license key.', 'elementskit' ), '<a href="http://account.wpmet.com/" target="_blank">', '</a>' ); ?></li>
                        ...
                        <div class="elementskit-license-form-result">
                            <p class="attr-alert attr-alert-info">
                                <?php printf( esc_html__( 'Still can\'t find your lisence key? %s', 'elementskit' ), '<a target="_blank" href="https://help.wpmet.com">Knock us here!</a>' ); ?>
                            </p>
                        </div>
