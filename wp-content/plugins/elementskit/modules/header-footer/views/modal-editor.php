		...
		<form action="" mathod="get" id="elementskit-template-modalinput-form" data-open-editor="0"
			...
			<div class="attr-modal-content">
				...
				<div class="attr-modal-footer">
					<button type="button" class="attr-btn attr-btn-default elementskit-template-save-btn-editor"><img src="<?php echo \ElementsKit::lib_url(); ?>framework/assets/images/ekit_icon.svg" alt="Ekit Icon"><?php esc_html_e('Edit with Elementor', 'elementskit'); ?></button>
