...
use \ElementsKit\Elementskit_Widget_Advanced_Tab_Handler as Handler;
            ...
            <ul class="<?php echo esc_attr($nav_wrapper_class); ?>" role="tablist">
                <?php foreach ($ekit_tab_items as $i=>$tab) :
                    ...
                    if(isset($tab['ekit_tab_title_icon_type']) && $tab['ekit_tab_title_icon_type'] == 'icon' && $tab['ekit_tab_title_icons'] != ''){
                        ...
                        if ( $is_new || $migrated ) {
                            ...
                            if ($tab['ekit_tab_title_icons']['library'] == 'svg' && !empty( $tab['ekit_tab_title_icons']['value']['url'] )) {
                                ...
                                $icon_html = !empty($tab['ekit_tab_title_icons']['value']) ? '<span class="'. $tab['ekit_tab_title_icons']['value'] .' elementskit-tab-icon" aria-hidden="true"></span>' : '';
                            }
                        } else {
                            $icon_html = '<span class="'. $tab['ekit_tab_title_icon'] .' elementskit-tab-icon" aria-hidden="true"></span>';
                        }
                    ...
                    $img_html = isset($tab['ekit_tab_title_icon_type']) && ($tab['ekit_tab_title_icon_type'] == 'image' && ! empty( $tab['ekit_tab_title_image']['url'] )) ?
                        '<div class="ekit-icon-image elementskit-tab-icon"><img src="'.$tab['ekit_tab_title_image']['url'].'" alt="'.Control_Media::get_image_alt( $tab['ekit_tab_title_image'] ).'" draggable="false"></div>' : '';
