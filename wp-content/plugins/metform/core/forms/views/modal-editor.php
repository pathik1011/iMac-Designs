            ...
            <div class="attr-modal-content">
                ...
                <div class="attr-tab-content">
                    ...
                    if ( class_exists('\MetForm_Pro\Core\Integrations\Mail_Poet')): ?>
                            ...
                            <div class="mf-input-group mf-zapier">
                                ...
                                <input type="text" name="mf_zapier_webhook" class="mf-zapier-web-hook attr-form-control"
                            ...
                            <div class="mf-input-group mf-slack">
                                ...
                                <input type="text" name="mf_slack_webhook" class="mf-slack-web-hook attr-form-control"
                ...
                <div class="attr-modal-footer">
                    <button type="button" class="attr-btn attr-btn-default metform-form-save-btn-editor"><img
                            ...
                            src="<?php echo \MetForm\Plugin::instance()->public_url() . 'assets/img/elementor-edit-logo.png'; ?>"><?php esc_html_e('Edit content', 'metform');?></button>
                    <button type="submit"
