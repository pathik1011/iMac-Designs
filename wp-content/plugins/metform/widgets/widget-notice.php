        ...
        if(!class_exists('\MetForm_Pro\Plugin')){
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '1',
                    'description' => '<span class="ekit-widget-pro-feature"> Get the  <a href="http://go.wpmet.com/metform-pro-widget-message" target="_blank">Pro version</a> for more awesome elements and powerful modules.</span>',
                ]
            );
