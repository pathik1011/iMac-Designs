 ...
 * @since 1.0.0
 */
function xpertiz_google_fonts_list() {
	$fonts = array(
		array(
			'abeezee' => array(
				'family' => 'ABeeZee',
		...
		array(
			'xpertiz-shadow' => array(
				'family' => 'Xpertiz Shadow',
				'variants' => array(
					'400',
				),
				'subsets' => array(
 ...
 */
function xpertiz_enqueue_gooogle_font( $font ) {

	$google_fonts = xpertiz_google_fonts_list();
	...
	wp_enqueue_style( 'xpertiz-google-font', $url, false, false, 'all' );
}
